  ...
  <fieldset>
    ...
    <div class="form-group">
      ...
      <!-- Configuration Demon distant -->
        ...
        <div class="col-md-1">
			<input type="checkbox" class="configKey form-control" style="width:auto;" data-l1key="RemoteDemon" checked/>
		</div>
        <!-- Version -->
		<label class="col-md-2 control-label">{{Version plugin}}</label>
		<div class="col-md-1">
            <?php
            	echo '<span class="label label-success"> '. config::byKey('pluginVersion', 'marstekmqtt', 'N/A') . '</span>';
            ?>
		</div>
    </div>
  </fieldset>
