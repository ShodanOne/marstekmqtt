...
$plugin = plugin::byId('marstekmqtt');
...
<div class="row row-overflow">
	...
	<div class="col-xs-12 eqLogicThumbnailDisplay">
		...
		<div class="eqLogicThumbnailContainer">
  			<!-- Boutons de gestion du plugin : Configuration -->
        ...
        <!-- Zone Equipements -->      
		<legend><i class="fas fa-table"></i> {{Mes Batteries}}</legend>
		<?php
		if (count($eqLogics) == 0) {
			echo '<br><div class="text-center" style="font-size:1.2em;font-weight:bold;">{{Aucune batterie trouvée sur le réseau}}</div>';
		} else {
			// Champ de recherche
	...
	<!-- Page de présentation de l équipement (Batterie) -->
	<div class="col-xs-12 eqLogic" style="display: none;">
		...
		<div class="tab-content">
			...
			<div role="tabpanel" class="tab-pane active" id="eqlogictab">
				...
				<!-- Paramètres généraux et spécifiques de l equipement -->
					...
					<fieldset>
						...
						<div class="col-lg-6">
							<legend><i class="fas fa-wrench"></i> {{Paramètres généraux}}</legend>
                  			...
                  			<!-- Paramètres général : Nom -->
							<div class="form-group">
								<label class="col-sm-4 control-label">{{Nom de la batterie}}</label>
								<div class="col-sm-6">
									<input type="text" class="eqLogicAttr form-control" data-l1key="id" style="display:none;">
									<input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="{{Nom de la batterie}}">
								</div>
							</div>
                              
                            <!-- Paramètres général : Objet Parent -->
							<div class="form-group">
                            ...
                            <!-- Paramètres généraaux : Activer / Visisble -->
							<div class="form-group">
                            ...
                            <!-- Paramètres specifiques Configuration réseau -->
							<legend><i class="fas fa-cogs"></i> {{Configuration Réseau}}</legend>
							...
							<div class="form-group">
								...
								<div class="col-sm-2">
                              	...
                              	<label class="col-sm-2 control-label">{{Ble MAC}}</label>
								<div class="col-sm-2">
                                		<span class="eqLogicAttr" data-l1key="configuration" data-l2key="ble_mac"></span>
                              	</div>
                            ...
                            <div class="form-group">
                              	...
                              	<label class="col-sm-2 control-label">{{Wifi MAC}}</label>
								<div class="col-sm-2">
                                		<span class="eqLogicAttr" data-l1key="configuration" data-l2key="wifi_mac"></span>
                                </div>
                              
                              	<label class="col-sm-2 control-label">{{Wifi SSID}}</label>
								<div class="col-sm-3">
                                		<span class="eqLogicAttr" data-l1key="configuration" data-l2key="wifi_name"></span>
                              	</div>
